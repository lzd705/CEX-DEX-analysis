...
class FrameworkStructureTest(unittest.TestCase):
    ...
    def test_administrator_is_a_separate_server_controlled_page(self):
        ...
        self.assertIn('id="token-reviews-body"', admin_html)
        self.assertIn('id="token-review-status"', admin_html)
        self.assertIn("/api/admin/token-reviews", admin_javascript)
        self.assertIn("expected_revision", admin_javascript)
