...
const historicalRows = Array.from({ length: 10 }, (_unused, index) => {
  ...
  return {
    ...
    token_symbol: "UNI",
    buy_market_id: direction === "uniswap_to_sushiswap" ? "dex:ethereum:uniswap_v2:UNI-WETH" : "dex:ethereum:sushiswap_v2:UNI-WETH",
    sell_market_id: direction === "uniswap_to_sushiswap" ? "dex:ethereum:sushiswap_v2:UNI-WETH" : "dex:ethereum:uniswap_v2:UNI-WETH",
    route_type: "dex_dex",
